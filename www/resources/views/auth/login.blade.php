                                            ...
                                            <div class="card-body pt-1">
                                                <form method="POST" action="{{ route('login') }}">
                                                    ...
                                                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                        <input id="email" type="email" id="user-name" class="form-control @error('email') is-invalid @enderror" name="email" value="@gmail.com" required autocomplete="email" autofocus>
