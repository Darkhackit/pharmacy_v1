        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                   ...
                   <a href="#addUser" data-toggle="modal" class="btn btn-primary">Add Category</a>
                   @endpermission
                </div>
                            ...
                            <table class="table table-striped dataex-html5-selectors">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @permission(['Category Edit','All'])
                                            <button class="btn btn-info btn-sm loadCat" id="{{$category->id}}"><i class="fa fa-pencil"></i></button>
                                            @endpermission
                                            @permission(['Category Delete','All'])
                                            <form id="deleteCategory" style="display:inline">
                                                @csrf
                                                @method('delete')
                                                  <input type="hidden" name="id" id="deleteR" value="{{ $category->id }}">
                                                  <button type="button" id="{{ $category->id }}" class="btn btn-danger btn-sm deleteCat"><i class="fa fa-trash-o"></i></button>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <div class="form-label-group position-relative has-icon-left">
                                                                        <input type="text" id="name"  class="form-control" name="category_name" placeholder="Category Name">
                                                                        <div class="form-control-position">
                                                                            <i class="fa fa-list"></i>
                                                                        </div>
                                                                        <label for="first-name-floating-icon">Category Name</label>
    ...
    $('.addCate').click(function () {
        ...
        $.ajax({
            ...
            success:function (response) {
                toastr.success('Category created successfully.', 'Category created successfully!', { "showMethod": "fadeIn", "hideMethod": "fadeOut", timeOut: 2000 });
            ...
            error: (jqXHR,textStatus , errorThrown) => {
                ...
                if(data.errors) {
                  if(data.errors.category_name) {
                       ...
                       $('#error-category_name').html(data.errors.category_name[0])
    ...
    $('.loadCat').click(function () {
        ...
        $.ajax({
            ...
            success:function (response) {
                ...
                $('#name').val(response.category.category_name)
    ...
    $('.editCate').click(function () {
        ...
        $.ajax({
            ...
            success:function (response) {
                ...
                toastr.success('Category updated successfully.', 'Category updated successfully!', { "showMethod": "fadeIn", "hideMethod": "fadeOut", timeOut: 2000 });
