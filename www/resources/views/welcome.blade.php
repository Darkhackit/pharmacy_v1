                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="{{URL::asset('app-assets/images/pages/login.png')}}" alt="branding logo">
                                </div>
                                            ...
                                            <div class="card-body pt-1">
                                                <form method="POST" action="{{ route('login') }}">
                                                    ...
                                                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                        <input id="email" type="email" id="user-name" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                                    ...
                                                    <button type="submit" class="btn btn-primary float-left btn-inline">  {{ __('Login') }}</button>
                                                </form>
                                            </div>
                                        </div>
