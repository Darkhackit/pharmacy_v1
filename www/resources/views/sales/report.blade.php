...
<div class="col-lg-12 col-md-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Daily Sales and Profit</h4>
        </div>
        <div class="card-content">
            <div class="card-body">
                <div id="line-area-day"></div>
            </div>
        </div>
    </div>
</div>
...
<div class="col-lg-12 col-md-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Weekly Sales and Profit</h4>
        </div>
        <div class="card-content">
            <div class="card-body">
                <div id="line-area-week"></div>
            </div>
        </div>
    </div>
</div>
...
<div class="col-lg-12 col-md-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Monthly Sales and Profit</h4>
        </div>
        <div class="card-content">
            <div class="card-body">
...
<div class="col-lg-12 col-md-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Yearly Sales and Profit</h4>
        </div>
        <div class="card-content">
            <div class="card-body">
                <div id="line-area-year"></div>
            </div>
        </div>
    </div>
</div>
    ...
    $(document).ready(function () {
        ...
        var lineAreaOptions = {
          ...
          series: [{
            name: 'Sales',
            data:  @php
                 echo  js_array($Wtotal)
             @endphp
          }, {
            name: 'Profit',
            data: @php
            echo  js_array($Wprofit)
        @endphp
          }],
          legend: {
            offsetY: -10
        ...
        var lineAreaChart = new ApexCharts(
          document.querySelector("#line-area-week"),
          lineAreaOptions
        );
        ...
        var lineAreaOptions = {
          ...
          var lineAreaOptions = {
              ...
              series: [{
                name: 'Sales',
                data:  @php
                     echo  js_array($Ytotal)
                 @endphp
              }, {
                name: 'Profit',
                data: @php
                echo  js_array($Yprofit)
            @endphp
              }],
              legend: {
                offsetY: -10
            ...
            var lineAreaChart = new ApexCharts(
              document.querySelector("#line-area-year"),
              lineAreaOptions
            );
            lineAreaChart.render();
            ...
            var lineAreaOptions = {
                ...
                series: [{
                  name: 'Sales',
                  data:  @php
                       echo  js_array($Dtotal)
                   @endphp
                }, {
                  name: 'Profit',
                  data: @php
                  echo  js_array($Dprofit)
              @endphp
                }],
                legend: {
                  offsetY: -10
              ...
              var lineAreaChart = new ApexCharts(
                document.querySelector("#line-area-day"),
                lineAreaOptions
              );
              lineAreaChart.render();
