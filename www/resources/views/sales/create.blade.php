    ...
    $('.btnSaveSales').click(function () {
        ...
        $.ajax({
            ...
            success:function (res) {
                ...
                if(res.success == true) {
                  ...
                  //  window.location.href = '{{url('createpdf')}}' + '/' + pri
                   toastr.success('Sales created successfully.', 'Sales updated successfully!', { "showMethod": "fadeIn", "hideMethod": "fadeOut", timeOut: 100 });
            ...
            error: (jqXHR,textStatus , errorThrown) => {
                ...
                console.log(data)
                toastr.error('An error occured !!', 'The sales wasnt saved ... please try again', { "showMethod": "fadeIn", "hideMethod": "fadeOut", timeOut: 10000 });
