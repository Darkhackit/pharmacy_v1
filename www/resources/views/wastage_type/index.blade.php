        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    @permission(['Unit Add','All'])
                   <a href="#addUser" data-toggle="modal" class="btn btn-primary">Add Wastage Type</a>
                   @endpermission
                </div>
...
<div class="modal fade text-left" id="addUser" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel17">Add Wastage Type</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
    $('.addCate').click(function () {
        ...
        $.ajax({
            url: "{{ route('wastage_type.store') }}",
            method:'POST',
            data:form,
            success:function (response) {
                toastr.success('Wastage Type created successfully.', 'Wastage Type created successfully!', { "showMethod": "fadeIn", "hideMethod": "fadeOut", timeOut: 2000 });
    ...
    $('.editCate').click(function () {
        ...
        $.ajax({
            ...
            success:function (response) {
                ...
                toastr.success('Wastage Type updated successfully.', 'Wastage Type updated successfully!', { "showMethod": "fadeIn", "hideMethod": "fadeOut", timeOut: 2000 });
