        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    @permission(['Expense Category Add','All'])
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped dataex-html5-selectors">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$category->expense_name}}</td>
                                        <td>{{ $category->description }}</td>
                                        <td>
                                            @permission(['Expense Category Edit','All'])
                                            <button class="btn btn-info btn-sm loadCat" id="{{$category->id}}"><i class="fa fa-pencil"></i></button>
                                            @endpermission
                                            @permission(['Expense Category Delete','All'])
...
<script>
    ...
    $('.loadCat').click(function () {
        ...
        let id = $(this).attr('id');
        $.ajax({
            url:'{{url('/expensecategory')}}' + '/' + id,
            method:'GET',
            data:{id:id},
            success:function (response) {

                $('#name').val(response.expense_name)
