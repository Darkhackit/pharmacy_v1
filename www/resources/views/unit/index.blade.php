        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                   ...
                   <a href="#addUser" data-toggle="modal" class="btn btn-primary">Add Unit</a>
                   @endpermission
                </div>
                            ...
                            <table class="table table-striped dataex-html5-selectors">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $unit->medicines->count() }}</td>

                                        <td>
                                            @permission(['Unit Edit','All'])
                                            <button class="btn btn-info btn-sm loadCat" id="{{$unit->id}}"><i class="fa fa-pencil"></i></button>
                                            @endpermission
                                            @permission(['Unit Delete','All'])
                                            <form id="deleteCategory" style="display:inline">
                                                @csrf
                                                @method('delete')
                                                  <input type="hidden" name="id" id="deleteR" value="{{ $unit->id }}">
                                                  <button type="button" id="{{ $unit->id }}" class="btn btn-danger btn-sm deleteCat"><i class="fa fa-trash-o"></i></button>
    ...
    $('.addCate').click(function () {
        ...
        $.ajax({
            ...
            success:function (response) {
                toastr.success('Unit created successfully.', 'Unit created successfully!', { "showMethod": "fadeIn", "hideMethod": "fadeOut", timeOut: 2000 });
    ...
    $('.editCate').click(function () {
        ...
        $.ajax({
            ...
            success:function (response) {
                ...
                toastr.success('Unit updated successfully.', 'Unit updated successfully!', { "showMethod": "fadeIn", "hideMethod": "fadeOut", timeOut: 2000 });
